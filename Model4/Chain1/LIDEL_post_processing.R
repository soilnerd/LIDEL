...
#code to run post-processing independently, loading saved workspace
  ...
  #load saved workspace from storage location
		load("C:/LIDEL_rubel/Model4/Chain1/results/trialrun_workspace.RData")
...
#parameter results
  ...
  #save param results
    write.csv(RESULTchain1_params, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_params.csv")

#variance results
  RESULTchain1_var=mcmc(x_Cinit[[2]][burnin:n.iter,])
  #save var results
    write.csv(RESULTchain1_var, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_var.csv")

#latent state results
    RESULTchain1_alfalfa=mcmc(x_Cinit[[3]][burnin:n.iter,])
      #save alfalfa results
      write.csv(RESULTchain1_alfalfa, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_alfalfa.csv")
    RESULTchain1_ash=mcmc(x_Cinit[[4]][burnin:n.iter,])
      #save ash results
      write.csv(RESULTchain1_ash, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_ash.csv")
    RESULTchain1_bluestem=mcmc(x_Cinit[[5]][burnin:n.iter,])
      #save bluestem results
      write.csv(RESULTchain1_bluestem, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_bluestem.csv")
    RESULTchain1_oak=mcmc(x_Cinit[[6]][burnin:n.iter,])
      #save oak results
      write.csv(RESULTchain1_oak, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_oak.csv")
    RESULTchain1_pine=mcmc(x_Cinit[[7]][burnin:n.iter,])
      #save pine results
      write.csv(RESULTchain1_pine, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_pine.csv")
  ...
  #MCMC object of all latent states
    ...
    #save all latent results
      write.csv(RESULTchain1_latent, file="C:/LIDEL/Model4/Chain1/results/RESULTchain1_latent.csv")

#print results to file
  sink("C:/LIDEL/Model4/Chain1/results/CHAIN1_summary.txt")
...
#parameters
  jpeg(file="C:/LIDEL/Model4/Chain1/plots/RESULTchain1_PARAMS_A.jpg")
    plot(RESULTchain1_params[,1:3])
  dev.off()
  jpeg(file="C:/LIDEL/Model4/Chain1/plots/RESULTchain1_PARAMS_B.jpg")
...
#variance- output in sets of 3
  for(p in 1:26){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain1/plots/RESULTchain1_var", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 1:63- output in sets of 3
  for(p in 1:21){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain1/plots/RESULTchain1_latent", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 64:65- stragglers
  fileNam=paste("C:/LIDEL/Model4/Chain1/plots/RESULTchain1_latent", 22, ".jpg", sep="")
  jpeg(file=fileNam)
...
for(i in 1:length(all_rmse)){
  ...
  #calculate RMSE for iteration
	...
	#write MCMC results
		write.csv(all_rmse, file="C:/LIDEL/Model4/Chain1/results/RMSE_data_Chain1.csv")
		
	#write summary results to file
	  sink("C:/LIDEL/Model4/Chain1/results/RMSE_summary.txt")
		  print(summary(all_rmse_MCMC))
	  sink()
	  
	#write plot of RMSE for MCMC to file
		jpeg(file="C:/LIDEL/Model4/Chain1/results/RMSE_results.jpg")
		  plot(all_rmse_MCMC)
		dev.off()
...
############plot meas/mod comparison Mass####################
  ...
  #write output for modeled mass measurements
    write.csv(CVmod_mass_alf1, file="C:/LIDEL/Model4/Chain1/results/CVmod_mass_alf1.csv")
    write.csv(CVmod_mass_ash1, file="C:/LIDEL/Model4/Chain1/results/CVmod_mass_ash1.csv")
    write.csv(CVmod_mass_blu1, file="C:/LIDEL/Model4/Chain1/results/CVmod_mass_blu1.csv")
    write.csv(CVmod_mass_oak1, file="C:/LIDEL/Model4/Chain1/results/CVmod_mass_oak1.csv")
    write.csv(CVmod_mass_pin1, file="C:/LIDEL/Model4/Chain1/results/CVmod_mass_pin1.csv")

  #write output for latent state modeled DOC measurements
    write.csv(t(est_fin_alf_DOC), file="C:/LIDEL/Model4/Chain1/results/CVmod_DOC_alf1.csv")
    write.csv(t(est_fin_ash_DOC), file="C:/LIDEL/Model4/Chain1/results/CVmod_DOC_ash1.csv")
    write.csv(t(est_fin_blu_DOC), file="C:/LIDEL/Model4/Chain1/results/CVmod_DOC_blu1.csv")
    write.csv(t(est_fin_oak_DOC), file="C:/LIDEL/Model4/Chain1/results/CVmod_DOC_oak1.csv")
    write.csv(t(est_fin_pin_DOC), file="C:/LIDEL/Model4/Chain1/results/CVmod_DOC_pin1.csv")
  ...
  #write output for latent state modeled CO2 measurements
    write.csv(t(est_fin_alf_CO2), file="C:/LIDEL/Model4/Chain1/results/CVmod_CO2_alf1.csv")
    write.csv(t(est_fin_ash_CO2), file="C:/LIDEL/Model4/Chain1/results/CVmod_CO2_ash1.csv")
    write.csv(t(est_fin_blu_CO2), file="C:/LIDEL/Model4/Chain1/results/CVmod_CO2_blu1.csv")
    write.csv(t(est_fin_oak_CO2), file="C:/LIDEL/Model4/Chain1/results/CVmod_CO2_oak1.csv")
    write.csv(t(est_fin_pin_CO2), file="C:/LIDEL/Model4/Chain1/results/CVmod_CO2_pin1.csv")
...
############plot meas/mod comparison mass####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain1/results/Meas_Mod_MASS.jpg")
...
############plot meas/mod comparison DOC####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain1/results/Meas_Mod_DOC.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
...
############plot meas/mod comparison CO2####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain1/results/Meas_Mod_CO2.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
