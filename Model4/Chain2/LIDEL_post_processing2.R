...
#code to run post-processing independently, loading saved workspace
  ...
  #load saved workspace from storage location
		load("C:/LIDEL_rubel/Model4/Chain2/results/trialrun_workspace2.RData")
...
#parameter results
  ...
  #save param results
    write.csv(RESULTchain2_params, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_params.csv")

#variance results
  RESULTchain2_var=mcmc(x_Cinit[[2]][burnin:n.iter,])
  #save var results
    write.csv(RESULTchain2_var, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_var.csv")

#latent state results
    RESULTchain2_alfalfa=mcmc(x_Cinit[[3]][burnin:n.iter,])
      #save alfalfa results
      write.csv(RESULTchain2_alfalfa, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_alfalfa.csv")
    RESULTchain2_ash=mcmc(x_Cinit[[4]][burnin:n.iter,])
      #save ash results
      write.csv(RESULTchain2_ash, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_ash.csv")
    RESULTchain2_bluestem=mcmc(x_Cinit[[5]][burnin:n.iter,])
      #save bluestem results
      write.csv(RESULTchain2_bluestem, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_bluestem.csv")
    RESULTchain2_oak=mcmc(x_Cinit[[6]][burnin:n.iter,])
      #save oak results
      write.csv(RESULTchain2_oak, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_oak.csv")
    RESULTchain2_pine=mcmc(x_Cinit[[7]][burnin:n.iter,])
      #save pine results
      write.csv(RESULTchain2_pine, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_pine.csv")
  ...
  #MCMC object of all latent states
    ...
    #save all latent results
      write.csv(RESULTchain2_latent, file="C:/LIDEL/Model4/Chain2/results/RESULTchain2_latent.csv")

#print results to file
  sink("C:/LIDEL/Model4/Chain2/results/chain2_summary.txt")
...
#parameters
  jpeg(file="C:/LIDEL/Model4/Chain2/plots/RESULTchain2_PARAMS_A.jpg")
    plot(RESULTchain2_params[,1:3])
  dev.off()
  jpeg(file="C:/LIDEL/Model4/Chain2/plots/RESULTchain2_PARAMS_B.jpg")
...
#variance- output in sets of 3
  for(p in 1:26){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain2/plots/RESULTchain2_var", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 1:63- output in sets of 3
  for(p in 1:21){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain2/plots/RESULTchain2_latent", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 64:65- stragglers
  fileNam=paste("C:/LIDEL/Model4/Chain2/plots/RESULTchain2_latent", 22, ".jpg", sep="")
  jpeg(file=fileNam)
...
for(i in 1:length(all_rmse)){
  ...
  #calculate RMSE for iteration
	...
	#write MCMC results
		write.csv(all_rmse, file="C:/LIDEL/Model4/Chain2/results/RMSE_data_chain2.csv")
		
	#write summary results to file
	  sink("C:/LIDEL/Model4/Chain2/results/RMSE_summary2.txt")
		  print(summary(all_rmse_MCMC))
	  sink()
	  
	#write plot of RMSE for MCMC to file
		jpeg(file="C:/LIDEL/Model4/Chain2/results/RMSE_results2.jpg")
		  plot(all_rmse_MCMC)
		dev.off()
...
############plot meas/mod comparison Mass####################
  ...
  #write output for modeled mass measurements
    write.csv(CVmod_mass_alf2, file="C:/LIDEL/Model4/Chain2/results/CVmod_mass_alf2.csv")
    write.csv(CVmod_mass_ash2, file="C:/LIDEL/Model4/Chain2/results/CVmod_mass_ash2.csv")
    write.csv(CVmod_mass_blu2, file="C:/LIDEL/Model4/Chain2/results/CVmod_mass_blu2.csv")
    write.csv(CVmod_mass_oak2, file="C:/LIDEL/Model4/Chain2/results/CVmod_mass_oak2.csv")
    write.csv(CVmod_mass_pin2, file="C:/LIDEL/Model4/Chain2/results/CVmod_mass_pin2.csv")

  #write output for latent state modeled DOC measurements
    write.csv(t(est_fin_alf_DOC), file="C:/LIDEL/Model4/Chain2/results/CVmod_DOC_alf2.csv")
    write.csv(t(est_fin_ash_DOC), file="C:/LIDEL/Model4/Chain2/results/CVmod_DOC_ash2.csv")
    write.csv(t(est_fin_blu_DOC), file="C:/LIDEL/Model4/Chain2/results/CVmod_DOC_blu2.csv")
    write.csv(t(est_fin_oak_DOC), file="C:/LIDEL/Model4/Chain2/results/CVmod_DOC_oak2.csv")
    write.csv(t(est_fin_pin_DOC), file="C:/LIDEL/Model4/Chain2/results/CVmod_DOC_pin2.csv")
  ...
  #write output for latent state modeled CO2 measurements
    write.csv(t(est_fin_alf_CO2), file="C:/LIDEL/Model4/Chain2/results/CVmod_CO2_alf2.csv")
    write.csv(t(est_fin_ash_CO2), file="C:/LIDEL/Model4/Chain2/results/CVmod_CO2_ash2.csv")
    write.csv(t(est_fin_blu_CO2), file="C:/LIDEL/Model4/Chain2/results/CVmod_CO2_blu2.csv")
    write.csv(t(est_fin_oak_CO2), file="C:/LIDEL/Model4/Chain2/results/CVmod_CO2_oak2.csv")
    write.csv(t(est_fin_pin_CO2), file="C:/LIDEL/Model4/Chain2/results/CVmod_CO2_pin2.csv")
...
############plot meas/mod comparison mass####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain2/results/Meas_Mod_MASS2.jpg")
...
############plot meas/mod comparison DOC####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain2/results/Meas_Mod_DOC2.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
...
############plot meas/mod comparison CO2####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain2/results/Meas_Mod_CO22.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
