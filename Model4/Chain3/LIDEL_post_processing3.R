...
#code to run post-processing independently, loading saved workspace
  ...
  #load saved workspace from storage location
		load("C:/LIDEL_rubel/Model4/Chain3/results/trialrun_workspace3.RData")
...
#parameter results
  ...
  #save param results
    write.csv(RESULTchain3_params, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_params.csv")

#variance results
  RESULTchain3_var=mcmc(x_Cinit[[2]][burnin:n.iter,])
  #save var results
    write.csv(RESULTchain3_var, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_var.csv")

#latent state results
    RESULTchain3_alfalfa=mcmc(x_Cinit[[3]][burnin:n.iter,])
      #save alfalfa results
      write.csv(RESULTchain3_alfalfa, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_alfalfa.csv")
    RESULTchain3_ash=mcmc(x_Cinit[[4]][burnin:n.iter,])
      #save ash results
      write.csv(RESULTchain3_ash, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_ash.csv")
    RESULTchain3_bluestem=mcmc(x_Cinit[[5]][burnin:n.iter,])
      #save bluestem results
      write.csv(RESULTchain3_bluestem, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_bluestem.csv")
    RESULTchain3_oak=mcmc(x_Cinit[[6]][burnin:n.iter,])
      #save oak results
      write.csv(RESULTchain3_oak, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_oak.csv")
    RESULTchain3_pine=mcmc(x_Cinit[[7]][burnin:n.iter,])
      #save pine results
      write.csv(RESULTchain3_pine, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_pine.csv")

  #MCMC object of all latent states
    RESULTchain3_latent=mcmc(cbind(
    ...
    #save all latent results
      write.csv(RESULTchain3_latent, file="C:/LIDEL/Model4/Chain3/results/RESULTchain3_latent.csv")

#print results to file
  sink("C:/LIDEL/Model4/Chain3/results/chain3_summary.txt")
...
#parameters
  jpeg(file="C:/LIDEL/Model4/Chain3/plots/RESULTchain3_PARAMS_A.jpg")
    plot(RESULTchain3_params[,1:3])
  dev.off()
  jpeg(file="C:/LIDEL/Model4/Chain3/plots/RESULTchain3_PARAMS_B.jpg")
...
#variance- output in sets of 3
  for(p in 1:26){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain3/plots/RESULTchain3_var", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 1:63- output in sets of 3
  for(p in 1:21){
    a=(p*3)-2
    c=(a+2)
    fileNam=paste("C:/LIDEL/Model4/Chain3/plots/RESULTchain3_latent", p, ".jpg", sep="")
    jpeg(file=fileNam)
...
#latent, cols 64:65- stragglers
  fileNam=paste("C:/LIDEL/Model4/Chain3/plots/RESULTchain3_latent", 22, ".jpg", sep="")
  jpeg(file=fileNam)
...
for(i in 1:length(all_rmse)){
  ...
  #calculate RMSE for iteration
	...
	#write MCMC results
		write.csv(all_rmse, file="C:/LIDEL/Model4/Chain3/results/RMSE_data_chain3.csv")
		
	#write summary results to file
	  sink("C:/LIDEL/Model4/Chain3/results/RMSE_summary3.txt")
		  print(summary(all_rmse_MCMC))
	  sink()
	  
	#write plot of RMSE for MCMC to file
		jpeg(file="C:/LIDEL/Model4/Chain3/results/RMSE_results3.jpg")
		  plot(all_rmse_MCMC)
		dev.off()
...
############plot meas/mod comparison Mass####################
  ...
  #write output for modeled mass measurements
    write.csv(CVmod_mass_alf3, file="C:/LIDEL/Model4/Chain3/results/CVmod_mass_alf3.csv")
    write.csv(CVmod_mass_ash3, file="C:/LIDEL/Model4/Chain3/results/CVmod_mass_ash3.csv")
    write.csv(CVmod_mass_blu3, file="C:/LIDEL/Model4/Chain3/results/CVmod_mass_blu3.csv")
    write.csv(CVmod_mass_oak3, file="C:/LIDEL/Model4/Chain3/results/CVmod_mass_oak3.csv")
    write.csv(CVmod_mass_pin3, file="C:/LIDEL/Model4/Chain3/results/CVmod_mass_pin3.csv")

  #write output for latent state modeled DOC measurements
    write.csv(t(est_fin_alf_DOC), file="C:/LIDEL/Model4/Chain3/results/CVmod_DOC_alf3.csv")
    write.csv(t(est_fin_ash_DOC), file="C:/LIDEL/Model4/Chain3/results/CVmod_DOC_ash3.csv")
    write.csv(t(est_fin_blu_DOC), file="C:/LIDEL/Model4/Chain3/results/CVmod_DOC_blu3.csv")
    write.csv(t(est_fin_oak_DOC), file="C:/LIDEL/Model4/Chain3/results/CVmod_DOC_oak3.csv")
    write.csv(t(est_fin_pin_DOC), file="C:/LIDEL/Model4/Chain3/results/CVmod_DOC_pin3.csv")
  ...
  #write output for latent state modeled CO2 measurements
    write.csv(t(est_fin_alf_CO2), file="C:/LIDEL/Model4/Chain3/results/CVmod_CO2_alf3.csv")
    write.csv(t(est_fin_ash_CO2), file="C:/LIDEL/Model4/Chain3/results/CVmod_CO2_ash3.csv")
    write.csv(t(est_fin_blu_CO2), file="C:/LIDEL/Model4/Chain3/results/CVmod_CO2_blu3.csv")
    write.csv(t(est_fin_oak_CO2), file="C:/LIDEL/Model4/Chain3/results/CVmod_CO2_oak3.csv")
    write.csv(t(est_fin_pin_CO2), file="C:/LIDEL/Model4/Chain3/results/CVmod_CO2_pin3.csv")
...
############plot meas/mod comparison mass####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain3/results/Meas_Mod_MASS3.jpg")
...
############plot meas/mod comparison DOC####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain3/results/Meas_Mod_DOC3.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
...
############plot meas/mod comparison CO2####################
  ...
  #create plot
    jpeg(file="C:/LIDEL/Model4/Chain3/results/Meas_Mod_CO23.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
