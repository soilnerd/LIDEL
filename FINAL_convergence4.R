...
#load results
  ...
  #Model4 parameter chains
    Param_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/RESULTchain1_params.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_param_chain1=mcmc(Param_chain1[,2:ncol(Param_chain1)])
    Param_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/RESULTchain2_params.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_param_chain2=mcmc(Param_chain2[,2:ncol(Param_chain2)])
    Param_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/RESULTchain3_params.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_param_chain3=mcmc(Param_chain3[,2:ncol(Param_chain3)])
  
  #Model4 variance chains
    Var_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/RESULTchain1_var.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_Var_chain1=mcmc(Var_chain1[,2:ncol(Var_chain1)])
    Var_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/RESULTchain2_var.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_Var_chain2=mcmc(Var_chain2[,2:ncol(Var_chain2)])
    Var_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/RESULTchain3_var.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_Var_chain3=mcmc(Var_chain3[,2:ncol(Var_chain3)])
  
  #Model4 latent chains
    Latent_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/RESULTchain1_latent.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_Latent_chain1=mcmc(Latent_chain1[,2:ncol(Latent_chain1)])
    Latent_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/RESULTchain2_latent.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      MC_Latent_chain2=mcmc(Latent_chain2[,2:ncol(Latent_chain2)])
    Latent_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/RESULTchain3_latent.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
...
#output summary for final results
  sink("C:/LIDEL/FINAL_results/Model4_SUMMARY.txt")
...
#create measured/modeled figures using model results from all chains
  #ALFALFA
    AlfMass_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_mass_alf1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfMass_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_mass_alf2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfMass_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_mass_alf3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #ASH
    AshMass_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_mass_ash1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshMass_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_mass_ash2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshMass_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_mass_ash3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #BLUESTEM
    BluMass_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_mass_blu1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluMass_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_mass_blu2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluMass_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_mass_blu3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #OAK
    OakMass_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_mass_oak1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakMass_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_mass_oak2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakMass_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_mass_oak3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #PINE
    PinMass_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_mass_pin1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinMass_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_mass_pin2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinMass_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_mass_pin3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
...
#create measured/modeled figures using model results from all chains
  #ALFALFA
    AlfDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_DOC_alf1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_DOC_alf2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_DOC_alf3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #ASH
    AshDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_DOC_ash1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_DOC_ash2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_DOC_ash3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #BLUESTEM
    BluDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_DOC_blu1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_DOC_blu2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_DOC_blu3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #OAK
    OakDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_DOC_oak1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_DOC_oak2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_DOC_oak3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #PINE
    PinDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_DOC_pin1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_DOC_pin2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_DOC_pin3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
...
#create measured/modeled figures using model results from all chains
  #ALFALFA
    AlfCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_CO2_alf1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_CO2_alf2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AlfCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_CO2_alf3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #ASH
    AshCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_CO2_ash1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_CO2_ash2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    AshCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_CO2_ash3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #BLUESTEM
    BluCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_CO2_blu1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_CO2_blu2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    BluCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_CO2_blu3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #OAK
    OakCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_CO2_oak1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_CO2_oak2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OakCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_CO2_oak3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #PINE
    PinCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/CVmod_CO2_pin1.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/CVmod_CO2_pin2.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    PinCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/CVmod_CO2_pin3.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
...
###################print Latent State Result Figures#####################
  #MASS
      jpeg(file="C:/LIDEL/FINAL_results/Model4_Mass.jpg", width=900, height=900, res=300)
  ...
  #DOC
        jpeg(file="C:/LIDEL/FINAL_results/Model4_DOC.jpg", width=900, height=900, res=300)
        par(mar=c(3.2, 3.3, 1, 1))
      #plot measured mean/modeled results
  ...
  #CO2
        jpeg(file="C:/LIDEL/FINAL_results/Model4_CO2.jpg", width=900, height=900, res=300)
        par(mar=c(3.2, 3.3, 1, 1))
      #plot measured mean/modeled results
...
#create measured/modeled figures for out-of-sample measurements using model results from all chains
  #ALFALFA
    OOSAlfDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_DOC_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSAlfDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_DOC_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSAlfDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_DOC_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #ASH
    OOSAshDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_DOC_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSAshDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_DOC_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSAshDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_DOC_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #BLUESTEM
    OOSBluDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_DOC_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSBluDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_DOC_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSBluDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_DOC_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #OAK
    OOSOakDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_DOC_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSOakDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_DOC_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSOakDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_DOC_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #PINE
    OOSPinDOC_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_DOC_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSPinDOC_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_DOC_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOSPinDOC_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_DOC_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #output figure for plot of DOC OOS loss
        jpeg(file="C:/LIDEL/FINAL_results/Model4_DOC_OOS.jpg", width=900, height=900, res=300)
        par(mar=c(3.2, 3.3, 1, 1))
      #plot measured mean/modeled results
...
#create measured/modeled figures using model results from all chains
  #ALFALFA
    OOS_AlfCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_CO2_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      OOS_AlfCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_CO2_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      OOS_AlfCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_CO2_alf.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #ASH
      OOS_AshCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_CO2_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      OOS_AshCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_CO2_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
      OOS_AshCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_CO2_ash.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #BLUESTEM
    OOS_BluCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_CO2_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_BluCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_CO2_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_BluCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_CO2_blu.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #OAK
    OOS_OakCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_CO2_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_OakCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_CO2_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_OakCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_CO2_oak.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #PINE
    OOS_PinCO2_chain1=read.csv("C:/LIDEL/Model4/Chain1/results/OOSchain1_CO2_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_PinCO2_chain2=read.csv("C:/LIDEL/Model4/Chain2/results/OOSchain2_CO2_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
    OOS_PinCO2_chain3=read.csv("C:/LIDEL/Model4/Chain3/results/OOSchain3_CO2_pin.csv", header=TRUE, sep=",", stringsAsFactors=FALSE)
  ...
  #Plot for figure of CO2 OOS results
      jpeg(file="C:/LIDEL/FINAL_results/Model4_CO2_OOS.jpg", width=900, height=900, res=300)
      par(mar=c(3.2, 3.3, 1, 1))
      #plot measured mean/modeled results
