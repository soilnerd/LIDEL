setwd("C:/Users/eecampbe/Desktop/trial/model_2_4")
library(deSolve)
library(gplots)
library(pscl)
library(rootSolve)
...
sink("C:/Users/eecampbe/Desktop/trial/model_2_4_SUMMARY.txt")
...
plotCI(list_dataMass, new_mass, err="y", ui=new_mass_uq, li=new_mass_lq, 
       main="Mass Loss V2_4", ylab="Modeled total C loss", typ="p", pch=16,
...
plotCI(list_dataDOC, new_DOC, err="y", ui=new_DOC_uq, li=new_DOC_lq, 
       main="DOC V2_4", ylab="Modeled DOC", typ="p", pch=16, 
...
plotCI(list_dataCO2, new_CO2, err="y", ui=new_CO2_uq, li=new_CO2_lq, 
       main="CO2 V2_4", ylab="Modeled CO2", typ="p", bty="n",
...
#MASS
jpeg(file="C:/Users/eecampbe/Desktop/trial/Mass_2_4.jpg")
...
#DOC
#plot DOC loss
jpeg(file="C:/Users/eecampbe/Desktop/trial/DOC_2_4.jpg")
par(mar=c(2.85, 2.85, 2.85, 2.85))
plotCI(list_dataDOC, new_DOC, err="y", ui=new_DOC_uq, li=new_DOC_lq, 
       typ="p", pch=16, bty="n",cex.main=2.5,
...
#CO2
#plot CO2 loss
jpeg(file="C:/Users/eecampbe/Desktop/trial/CO2_2_4.jpg")
par(mar=c(2.85, 2.85, 2.85, 2.85))
plotCI(list_dataCO2, new_CO2, err="y", ui=new_CO2_uq, li=new_CO2_lq, 
