...
all_rmse[i]=rmse(all_error)
	...
	#write MCMC results
		write.csv(all_rmse, file="C:/LIDEL/Model3/Chain2/results/RMSE_data_chain2.csv")
		
	#write summary results to file
	  sink("C:/LIDEL/Model3/Chain2/results/RMSE_summary2.txt")
		  print(summary(all_rmse_MCMC))
	  sink()
	  
	#write plot of RMSE for MCMC to file
		jpeg(file="C:/LIDEL/Model3/Chain2/results/RMSE_results2.jpg")
		  plot(all_rmse_MCMC)
		dev.off()
...
############plot meas/mod comparison Mass####################
	...
	CVmod_mass_pin2=cbind(apply(t(x_Cinit[[8]][[5]][96,2:6,]), 1, sum),
		...
		write.csv(CVmod_mass_alf2, file="C:/LIDEL/Model3/Chain2/results/CVmod_mass_alf2.csv")
		write.csv(CVmod_mass_ash2, file="C:/LIDEL/Model3/Chain2/results/CVmod_mass_ash2.csv")
		write.csv(CVmod_mass_blu2, file="C:/LIDEL/Model3/Chain2/results/CVmod_mass_blu2.csv")
		write.csv(CVmod_mass_oak2, file="C:/LIDEL/Model3/Chain2/results/CVmod_mass_oak2.csv")
		write.csv(CVmod_mass_pin2, file="C:/LIDEL/Model3/Chain2/results/CVmod_mass_pin2.csv")
		
		#write output for latent state modeled DOC measurements
		write.csv(t(est_fin_alf_DOC), file="C:/LIDEL/Model3/Chain2/results/CVmod_DOC_alf2.csv")
		write.csv(t(est_fin_ash_DOC), file="C:/LIDEL/Model3/Chain2/results/CVmod_DOC_ash2.csv")
		write.csv(t(est_fin_blu_DOC), file="C:/LIDEL/Model3/Chain2/results/CVmod_DOC_blu2.csv")
		write.csv(t(est_fin_oak_DOC), file="C:/LIDEL/Model3/Chain2/results/CVmod_DOC_oak2.csv")
		write.csv(t(est_fin_pin_DOC), file="C:/LIDEL/Model3/Chain2/results/CVmod_DOC_pin2.csv")
		...
		write.csv(t(est_fin_alf_CO2), file="C:/LIDEL/Model3/Chain2/results/CVmod_CO2_alf2.csv")
		write.csv(t(est_fin_ash_CO2), file="C:/LIDEL/Model3/Chain2/results/CVmod_CO2_ash2.csv")
		write.csv(t(est_fin_blu_CO2), file="C:/LIDEL/Model3/Chain2/results/CVmod_CO2_blu2.csv")
		write.csv(t(est_fin_oak_CO2), file="C:/LIDEL/Model3/Chain2/results/CVmod_CO2_oak2.csv")
		write.csv(t(est_fin_pin_CO2), file="C:/LIDEL/Model3/Chain2/results/CVmod_CO2_pin2.csv")
  ...
  jpeg(file="C:/LIDEL/Model3/Chain2/results/Meas_Mod_MASS2.jpg")
...
############plot meas/mod comparison DOC####################
  ...
  fin_fin_pin_DOC=mcmc(t(est_fin_pin_DOC))
    ...
    jpeg(file="C:/LIDEL/Model3/Chain2/results/Meas_Mod_DOC2.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
...
############plot meas/mod comparison CO2####################
  ...
  fin_fin_pin_CO2=mcmc(t(est_fin_pin_CO2))
    ...
    jpeg(file="C:/LIDEL/Model3/Chain2/results/Meas_Mod_CO22.jpg")
      colors=c("orange", "lightblue", "lightgreen", "darkgrey", "pink", "blue")
      #plot mass loss
